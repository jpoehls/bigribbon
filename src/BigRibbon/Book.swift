...
class Book : CustomStringConvertible {
    ...
    static let sam1 = Book(id:9, osisId:"1Sam", name:"1\u{00a0}Samuel", chapters:31)
    static let sam2 = Book(id:10, osisId:"2Sam", name:"2\u{00a0}Samuel", chapters:24)
    static let kgs1 = Book(id:11, osisId:"1Kgs", name:"1\u{00a0}Kings", chapters:22)
    static let kgs2 = Book(id:12, osisId:"2Kgs", name:"2\u{00a0}Kings", chapters:25)
    static let chr1 = Book(id:13, osisId:"1Chr", name:"1\u{00a0}Chronicles", chapters:29)
    static let chr2 = Book(id:14, osisId:"2Chr", name:"2\u{00a0}Chronicles", chapters:36)
    ...
    static let song = Book(id:22, osisId:"Song", name:"Song\u{00a0}of\u{00a0}Solomon", chapters:8)
    ...
    static let cor1 = Book(id:46, osisId:"1Cor", name:"1\u{00a0}Corinthians", chapters:16)
    static let cor2 = Book(id:47, osisId:"2Cor", name:"2\u{00a0}Corinthians", chapters:13)
    ...
    static let thess1 = Book(id:52, osisId:"1Thess", name:"1\u{00a0}Thessalonians", chapters:5)
    static let thess2 = Book(id:53, osisId:"2Thess", name:"2\u{00a0}Thessalonians", chapters:3)
    static let tim1 = Book(id:54, osisId:"1Tim", name:"1\u{00a0}Timothy", chapters:6)
    static let tim2 = Book(id:55, osisId:"2Tim", name:"2\u{00a0}Timothy", chapters:4)
    ...
    static let pet1 = Book(id:60, osisId:"1Pet", name:"1\u{00a0}Peter", chapters:5)
    static let pet2 = Book(id:61, osisId:"2Pet", name:"2\u{00a0}Peter", chapters:3)
    static let john1 = Book(id:62, osisId:"1John", name:"1\u{00a0}John", chapters:5)
    static let john2 = Book(id:63, osisId:"2John", name:"2\u{00a0}John", chapters:1)
    static let john3 = Book(id:64, osisId:"3John", name:"3\u{00a0}John", chapters:1)
